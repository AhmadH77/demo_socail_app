            ...
            child: Row(
              ...
              children: [
                IconButton(onPressed: (){},
                    icon: Image.asset('assets/icons/ArrowCounterClockwise.png',color: Colors.white),//Icon(Icons.forward_5,color: Colors.white,)
                ),
                IconButton(onPressed: (){},
                    icon: Image.asset('assets/icons/Pause.png',color: Colors.white),//Icon(Icons.pause,color: Colors.white)
                ),
                IconButton(onPressed: (){},
                    icon: Image.asset('assets/icons/ArrowClockwise.png',color: Colors.white,),//Icon(Icons.replay_5,color: Colors.white,textDirection: TextDirection.rtl,)
                ),
              ],
            ),
          ),
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: IconButton(
                      ...
                      icon:  Image.asset('assets/icons/Crown.png',color: Colors.white),// Icon(Icons.celebration_outlined, color: Colors.white,)
                    ),
                  ),
                  Spacer(),
                  IconButton(onPressed: (){
                    Navigator.pop(context);
                  }, icon: Image.asset('assets/icons/ArrowsIn.png',color: Colors.white),)
                ],
              ),
            ),
          ),
